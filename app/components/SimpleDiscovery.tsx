...
export default function SimpleDiscovery({ onSearch }: SimpleDiscoveryProps) {
  return (
    <div className="space-y-8">
      ...
      </div>      {/* Trending Section avec vraies covers */}
      ...
      {/* Newest Section - Nouvelles sorties */}
      <div className="relative">
        <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl blur-xl"></div>
        <div className="relative bg-gray-900/50 backdrop-blur-sm rounded-xl p-5 border border-gray-700/30">
          <NewestSection onSearch={onSearch} />
        </div>
      </div>

      {/* Recommendations Section - Personnalisé */}
      <div className="relative">
      ...
      <div className="relative">
        ...
        <div className="relative bg-gray-900/50 backdrop-blur-sm rounded-xl p-5 border border-gray-700/30">
          <ThematicCollectionsSection onSearch={onSearch} />
        </div>
      </div>      {/* Section découverte par catégories */}
      <div className="bg-gray-900/30 backdrop-blur-sm rounded-xl p-5 border border-gray-700/20">
